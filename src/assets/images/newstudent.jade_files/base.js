...
pba=function(){var a=window.location.protocol,b=mh.getEntriesByType("resource"),c=g.Qa(b,function(b){return 0==b.name.indexOf(a+"//fonts.googleapis.com/css?family=")});
b=(0,g.Hh)(b,function(b){return 0==b.name.indexOf(a+"//fonts.gstatic.com/s/")});
